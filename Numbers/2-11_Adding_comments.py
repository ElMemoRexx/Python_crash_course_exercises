...
# We have to create a value that stores your
# favorite number, then you should have to print
# a message showing your favorite number
favorite_num = 14
print(f'My favorite number is: "{favorite_num}"')


# This is the "+" operator, it is commonly used
# to subtractions like "5+2", the expected output
# would be "8"
addition = 5 + 3
print(addition)

"""
import this # This is the command 
